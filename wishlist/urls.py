...
from wishlist.views import logout_user, wishlist_ajax, wishlist_ajax_add #sesuaikan dengan nama fungsi yang dibuat
...
urlpatterns = [
    ...
    path('ajax/submit/', wishlist_ajax_add, name='wishlist_ajax_add'),
]